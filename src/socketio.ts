...
const isSupportNotify = typeof Notification === 'function' && typeof Notification.requestPermission === 'function';
...
export default class SocketIO {
    ...
    constructor(store: Store<RootState>) {
        ...
        this.socket.on('asset update', (message: VideoResponse[]) => this.on_asset_update(message));
