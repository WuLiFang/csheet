// Code Generated from [index.mutations.ts.gotmpl], DO NOT EDIT.
import { mutate as collectFromCGTeamwork } from './collectFromCGTeamwork';
import { mutate as collectFromFolder } from './collectFromFolder';
