...
export const vue = {
  cgteamworkFlows: cgteamworkFlowsVue,
  cgteamworkPipelines: cgteamworkPipelinesVue,
  cgteamworkProjects: cgteamworkProjectsVue,
  cgteamworkStatuses: cgteamworkStatusesVue,
  clientConfig: clientConfigVue,
